...
<?php
	...
	$rec_limit = 10;
	 ...
	 /* Get total number of records */
         $sql = "SELECT count(post_id) FROM posts WHERE post_type='event' OR post_type='council' ";
	...
	$sql = "SELECT * FROM posts WHERE post_type='event' OR post_type='council' ORDER BY post_id DESC LIMIT $offset, $rec_limit";
	$retval = mysql_query( $sql);
...
<?php }
		...
		?>
		<ul class="pager">
			<li class="previous"><a href="home.php?midcol=event_council&page=<?php echo $last; ?>">&larr; Previous</a></li> 
			<li class="next"><a href="home.php?midcol=event_council&page=<?php echo $page; ?>">Next &rarr;</a></li>
		</ul>
