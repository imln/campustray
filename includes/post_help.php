...
<?php
	...
	$rec_limit = 10;
	 ...
	 /* Get total number of records */
         $sql = "SELECT count(post_id) FROM posts WHERE post_type='help'";
	...
	$sql = "SELECT * FROM posts WHERE post_type='help' ORDER BY post_id DESC LIMIT $offset, $rec_limit";
	$retval = mysql_query( $sql);
...
<?php }
		...
		?>
		<ul class="pager">
			<li class="previous"><a href="home.php?midcol=help&page=<?php echo $last; ?>">&larr; Previous</a></li> 
			<li class="next"><a href="home.php?midcol=help&page=<?php echo $page; ?>">Next &rarr;</a></li>
		</ul>
